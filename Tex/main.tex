...
\titulo{ANÁLISE DE ROBUSTEZ DO MÉTODO NERI BASEADO NAS HIPÓTESES DA \textsl{NETWORK MEDICINE} PARA PRIORIZAÇÃO GÊNICA}
...
\begin{folhadeaprovacao}
  ...
  \vspace{-1cm}%
  \begin{center}
    Aprovado em 13 de Julho de 2017.\\[15mm]
    \textbf{COMISSÃO EXAMINADORA}\\[5mm]
    \assinatura{\imprimirorientador \\
      Instituto Federal do Espírito Santo\\
      Campus Serra}\vspace{-1cm}
    \assinatura{ \\Profª Drª Helena Paula Brentani\\
      Universidade de São Paulo\\
      Instituto de Psiquiatria\\
      }\vspace{-1cm}
    \assinatura{Prof. Dr. David Correa Martins-Jr \\
      Universidade Federal do ABC\\
      Centro de Matemática, Computação e Cognição}\vspace{-1cm}
    \assinatura{Prof. MSc. Thiago Meireles Paixão \\
      Instituto Federal do Espírito Santo\\
      Campus Serra}
  \end{center}
...
\begin{epigrafe}
    \vspace*{\fill}
	\begin{flushright}
		%\textit {Se as escolhas dos seus rios lhe levarem para um mar não pretendido... apenas saiba que não importa a força do vento, sempre terá braços para remar ao seu destino. } \\ \\ João Carlos Pandolfi Santana
